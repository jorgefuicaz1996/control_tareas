...
urlpatterns = [
	...
	path('quitar-tarea/<int:tarea>/<int:responsable>', views.quitar_responsable, name = 'quitar-responsable'),
	path('tareas', views.ListaTareasView.as_view(), name = 'lista-tareas'),
	path('tareas/modificar/<int:tarea>', views.ModificarTareaView.as_view(), name = 'modificar-tarea'),
